...
describe('useDynamicList', () => {
  function TestList(config: FieldListConfig<Variant>) {
    const {fields} = useDynamicList<Variant>(config, factory);
  ...
  it('accepts a list as argument', () => {
    function ListArgTestList({list}: {list: Variant[]}) {
      const {fields} = useDynamicList<Variant>(list, factory);
  ...
  describe('imperative methods', () => {
    ...
    describe('add and remove fields', () => {
      function DynamicListComponent(config: FieldListConfig<Variant>) {
        const {fields, addField, removeField} = useDynamicList<Variant>(
          config,
          factory,
        );
